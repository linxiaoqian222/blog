					...
					<c:otherwise>
						<c:forEach var="blog" items="${blogList }">
					  	  <li style="margin-bottom: 20px">
						  	...
						  	<span class="summary">摘要: <a href="${pageContext.request.contextPath}/blog/articles/${blog.id}.html">${blog.content }...</a></span>
						  	<span class="link">发布日期：${blog.releaseDateStr }</span>
						  </li>
						</c:forEach>
					</c:otherwise>
				</c:choose>
